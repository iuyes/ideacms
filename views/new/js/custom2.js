            ...
            $('form#contact-form').submit(function () {
                ...
                $('.requiredField').each(function () {
                    if (jQuery.trim($(this).val()) == '') {
                        ...
                        $("#error-field").append('<div class="notification error"><p><i class="fa fa-warning-sign"></i>Please Enter ' +
                            formInput + '</p></div> ');
                        ...
                        if (!emailReg.test(jQuery.trim($(this).val()))) {
                            var formInput = $(this).attr("title");
                            $("#error-field").append(
                                '<div class="notification error"><p><i class="fa fa-warning-sign"></i>You entered an invalid Value - ' +
                                formInput + '</p></div>');
                            $(this).addClass('inputError');
                            hasError = true;
                        }
                ...
                if (!hasError) {
                    ...
                    $.post($(this).attr('action'), formInput, function (data) {
                        $('#contact-form').prepend(
                            '<div class="notification success"><p> <i class="fa fa-check-sign"></i>Your email was successfully sent. We will contact you as soon as possible.</p></div>'
                        );
...
jQuery(document).ready(function() {
   ...
   // var defaultPattern = jQuery.cookie("portable_cookie_defaultBg");
    ...
    jQuery('#imore_select').mouseover(function(){
        jQuery('#imore_color').css('display','block');
    }).mouseout(function(){
        jQuery('#imore_color').css('display','none');
    });
