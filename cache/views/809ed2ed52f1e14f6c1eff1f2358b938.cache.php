...
<a href="<?php echo url('admin/adsense'); ?>"><em>广告位管理</em></a><span>|</span>
<a href="<?php echo url('admin/adsense/alist', array('aid'=>$aid)); ?>"><em>广告管理</em></a><span>|</span>
<a href="<?php echo url('admin/adsense/adda', array('aid'=>$aid)); ?>" class="on"><em>添加广告</em></a><span>|</span>
...
function getField(obj) {
	var tid = obj.value;
	$.get("<?php echo url('admin/adsense/ajaxfield'); ?>", {tid:tid}, function(data) {
