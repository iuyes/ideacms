...
<a href="<?php echo url('admin/adsense/index'); ?>" class="on"><em>广告位管理</em></a><span>|</span>
<a href="<?php echo url('admin/adsense/add'); ?>"><em>添加广告位</em></a><span>|</span>
...
<table width="100%">
	...
	<tr height="25">
	  ...
	  <td align="left">
      <a href="<?php echo url('admin/adsense/alist/',array('aid'=>$t[id])); ?>">广告管理</a> |
      <a href="<?php echo url('admin/adsense/edit/',array('id'=>$t[id])); ?>">修改</a> |
      <a href="javascript:;" onClick="if(confirm('确定删除吗？')){ window.location.href='<?php echo url('admin/adsense/del/',array('id'=>$t['id'])); ?>'; }">删除</a> |
