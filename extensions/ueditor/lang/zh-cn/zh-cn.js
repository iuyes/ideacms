...
UE.I18N['zh-cn'] = {
    ...
    'insertimage':{
        ...
        'flashError':'Flash应用初始化失败，请更新您的FlashPlayer版本之后重试！',
        'floatDefault':"默认",
        'floatLeft':"左浮动",
        'floatRight':"右浮动",
        'floatCenter':"居中",
    ...
    'snapscreen':{
        'static':{
            lang_showMsg:"截图功能需要首先安装UEditor截图应用！ ",
            lang_download:"点此下载",
            lang_step1:"第一步，下载UEditor截图应用并运行安装。",
            lang_step2:"第二不，应用安装完成后即可使用，如不生效，请重启浏览器后再试！"
        }
    },
    'insertvideo':{
        'static':{
    ...
    'wordimage':{
        ...
        'fileType':"图片",
        'flashError':"FLASH初始化失败，请检查FLASH应用是否正确安装！",
        'netError':"网络连接错误，请重试！",
